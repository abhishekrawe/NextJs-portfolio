            ...
            <div className="py-24">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col lg:flex-row justify-between w-full h-full py-24 gap-24">
                        <div>
                            ...
                            <p className="text-xl mt-1">
                                What is FLUX?
                                FLUX is many things. There is a big ecosystem which includes PoW mining, running nodes, there is a drive where you can host your files, and they also offer you an easy (and cheap) way to host your web apps. Most important of all is that everything is...
                            </p>
                        </div>
                    ...
                    <div className="flex flex-col lg:flex-row justify-between w-full h-full py-24 gap-24">
                        ...
                        <div>
                            <h1 className="text-4xl font-bold">6 ChatGPT  <span className="relative whitespace-nowrap text-primary">mind-blowing extensions </span>to use it anywhere</h1>
                            <p className="text-xl mt-1">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between w-full h-full py-24 gap-24">
                        <div>
                            <h1 className="text-4xl font-bold">2023  <span className="relative whitespace-nowrap text-primary">UX/UI Design </span>Trends</h1>
                            <p className="text-xl mt-1">
